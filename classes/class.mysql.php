<?php
	...
	**/
	class MySQL {
		...
		private $db_host    = mysql_host;  // server name
		private $db_user    = mysql_user;       // user name
		private $db_pass    = mysql_password;           // password
		private $db_dbname  = mysql_ragnarok_database;           // database name
